...
NON_FORKED_LOCAL_BLOCKCHAIN_ENVIRONMENTS = ["hardhat", "development", "localhosttobias"]
...
def update_front_end():
    ...
    with open("brownie-config.yaml", "r") as brownie_config:
        ...
        with open(
            "./front_end/solid_state/src/brownie-config.json", "w"
        ) as brownie_config_json:
            json.dump(config_dict, brownie_config_json)

        with open("./rest_api/brownie-config.json", "w") as brownie_config_json:
            json.dump(config_dict, brownie_config_json)
